...
class _HomePageState extends State<HomePage> {
  ...
  Widget buildServiceProduct(
      String CompanyName, String Subtitle, String ProductImage, int price) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Container(
        width: 250,
  ...
  Widget buildSrviceCategoryCard(String title, String imagePath, Color color) {
    return Container(
      height: 300,
      width: 300,
                  ...
                  Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final categories = [
                          {'title': 'Chemical', 'imagePath': 'assets/images/CategoryImages/Chemicals.png'},
                          {'title': 'Janitorials', 'imagePath': 'assets/images/CategoryImages/cleaing.png'},
                          {'title': 'Machines', 'imagePath': 'assets/images/CategoryImages/vaccum.png'},
                          {'title': 'Paper', 'imagePath': 'assets/images/CategoryImages/paper.png'},
                          {'title': 'PPE', 'imagePath': 'assets/images/CategoryImages/ppe.png'},
                          {'title': 'Amenities', 'imagePath': 'assets/images/CategoryImages/hospital.png'},
                        ];
